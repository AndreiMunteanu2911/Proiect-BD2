public class Persoana {
    ...
    private String nume;
    private int varsta;
    private int adresaId; // Change from Adresa to int
    ...
    public Persoana(int id, String nume, int varsta, int adresaId, String locDeNastere, String cnp, String cetatenie) {
        ...
        this.nume = nume;
        this.varsta = varsta;
        this.adresaId = adresaId; // Set the adresaId
    ...
    public int getAdresaId() {
        return adresaId; // Getter for adresaId
    }

    public void setAdresaId(int adresaId) {
        this.adresaId = adresaId; // Setter for adresaId
    }
